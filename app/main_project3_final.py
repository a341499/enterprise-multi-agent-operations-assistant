...
if st.button("Run Multi-Agent Workflow"):
    ...
    if not user_input.strip():
        ...
        # Shows how agents collaborate in the workflow
...
"""
        ...
        # This highlights the most important decision output first
        st.subheader("Executive Summary")

        # Display the response summary at the top
        # This gives users a quick operational overview before detailed agent output
        st.info(response.split("---")[0])
